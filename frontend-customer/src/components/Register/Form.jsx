    ...
    <div className='flex flex-col p-20'>
        <div className='w-[550px]'>
            ...
            <form onSubmit={AddData} className='flex flex-col mt-5 '>
                ...
                <button type='submit' className='w-full h-[48px] sm:flex justify-center items-center text-white black-bg rounded-lg hidden mt-5'>
                    Buat Akun
                </button>
                <p className='text-gray mt-6'>Sudah memiliki akun? <Link className='black-text font-medium' to='/login'>Masuk</Link> </p>
            </form>
